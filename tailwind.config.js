...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: { sans: ["Inter","Be Vietnam Pro","system-ui","-apple-system","Segoe UI","sans-serif"], display: ["Inter","Be Vietnam Pro","system-ui","-apple-system","Segoe UI","sans-serif"], serif: ["Inter","Be Vietnam Pro","system-ui","-apple-system","Segoe UI","sans-serif"], mono: ["JetBrains Mono","IBM Plex Mono","monospace"] },
